...
class Monster(models.BaseModel):
    ...
    species: MonsterSpecies = fields.ForeignKeyField('monsters.MonsterSpecies', related_name="monsters")
    ...
    gender: constants.MonsterGenders = fields.SmallIntField(constants.MonsterGenders, default=constants.MonsterGenders.FEMALE.value)
    ...
    boss_of: Gate | None = fields.ForeignKeyField('gates.Gate', related_name="boss", null=True)


class MonsterSpecies(models.BaseModel):
    """Monster species."""
    name: str = fields.CharField(max_length=255)
    slug: str = fields.CharField(max_length=255)
    monster_class: MonsterClasses = fields.SmallIntField(MonsterClasses, default=MonsterClasses.SLIME.value)


class MonsterStat(models.BaseModel):
